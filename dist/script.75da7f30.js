...
var ul = document.querySelector('.work');
...
function list(value) {
  ul.innerHTML += "\n  <li class = \"new__block\">\n       <input type=\"radio\">\n       <p class = \"new__text\">".concat(value, "</p> \n       <img class = \"delete\" src=\"/dump.d496a47b.png\";   \n  </li>\n  ");
  deleteList();
  check();
}

function deleteList() {
  document.querySelectorAll('.delete').forEach(function (value) {
    return value.addEventListener('click', function () {
...
function check() {
  ul.querySelectorAll('[type="radio"]').forEach(function (value) {
